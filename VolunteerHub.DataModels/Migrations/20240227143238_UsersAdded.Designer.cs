...
namespace VolunteerHub.DataModels.Migrations
{
    ...
    [Migration("20240227143238_UsersAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VolunteerHub.DataModels.Models.Role", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("VolunteerHub.DataModels.Models.UserRole", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("VolunteerHub.DataModels.Models.ProjectTask", b =>
                {
                    b.HasOne("VolunteerHub.DataModels.Models.User", "Assignee")
            ...
            modelBuilder.Entity("VolunteerHub.DataModels.Models.UserRole", b =>
                {
                    b.HasOne("VolunteerHub.DataModels.Models.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .IsRequired()
